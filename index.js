    ...
    Data: new Object({
        ObjFastConfig: {
            ...
            "Websocket_Extension": {
                "Status": false,
                "ResetData": false,
                "AppState_Path": "appstate.json" //fbstate.json or appstate.json or ...
            },
            "HTML": {   
                "HTML": true,
                "UserName": "Guest",
                ...
                case false: {
                    ...
                    if (!NodeVersion.includes("v14") && !NodeVersion.includes("v16") && !Database(true).has('SkipReplitNix')) {
                        ...
                        try {
                            ...
                            console.log(e);
                            log.error("[ FCA-UPDATE ] ➣","NodeJS v14 Installation Failed, Please Try Again and Contact fb.com/kemsadboiz!");
                            process.exit(0);
                        }
                    }
                }
        ...
        let Data = JSON.parse(res.body);
            if (global.Fca.Require.FastConfig.Stable_Version.Accept == true) {
                if (Data.Stable_Version.Valid_Version.includes(global.Fca.Require.FastConfig.Stable_Version.Version)) {
                    ...
                    log.warn("[ FCA-UPDATE ] ➣", "Error Stable Version, Please Check Your Stable Version in FastConfigFca.json, Automatically turn off Stable Version!");
